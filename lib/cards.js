...
var rand = exports.rand = require('rand-utils');

exports.useArc4 = false;

// Expose an easier way to seed the ARC4 PRNG
exports.seedArc4 = function(seed) {
	return rand.arc4.seed(seed);
};
...
Deck.createType = function(name, generator, constructor) {
	...
	exports[name].prototype = Object.create(Deck.prototype);
};
