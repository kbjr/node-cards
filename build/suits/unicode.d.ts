 ...
 */
export declare const unicodeSuits: Map<Suit, string>;
/**
 ...
 */
export declare const unicodeCards: Map<Suit, Map<Rank, string>>;
/**
 *
 */
export declare const unicodeJokers: Map<jokerColor, string>;
